...
ADAMS_exec = '' ;
ADAMS_host = 'DESKTOP-9TSPNQ9.home' ;
ADAMS_cwd ='C:\Users\mrahimid\OneDrive - Vrije Universiteit Brussel\Multibody Dynamics\Matlab Files\LAST4' ;
...
ADAMS_init = '' ;
ADAMS_inputs  = 'matlab_torque' ;
ADAMS_outputs = 'omega!theta!WL!WR!THETAD_A.THETAD_A_input' ;
